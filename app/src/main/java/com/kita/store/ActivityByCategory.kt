...
class ActivityByCategory : AppCompatActivity() {
    ...
    private fun getProduct(){
        ...
        var reques = JsonArrayRequest(Request.Method.GET, "http://192.168.17.150/store/apiproductid.php?cat_id="+GlobalData.idCategory, null, Response.Listener { response ->
            for (s in 0..response.length() - 1){
                ...
                var photo = job.getString("photo").replace("localhost", "192.168.17.150")
